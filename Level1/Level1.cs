...
namespace Level1
{
    public static class Level1
    {
        ...
        public static void StartOnEngine(IEngine engine)
        {
            ...
            scene.AddObject(Note.Create(new Vector2(2, 8), "Этот мир так чудесен, безупречная флора и фауна,\n безупречный баланс рас... \n "));
            ...
            CreateTextTrigger(new Vector2(12f, 19f), new[] { ("Крысы, не видят сквозь стекло. Глупые твари.", 5000),
            ...
            CreateTextTrigger(new Vector2(27, 9), new[] { ("Они не двигаются! Чертовщина, какой-то выстовочный зал.", 5000),
