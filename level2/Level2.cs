...
namespace level2
{
    public class Level2
    {
        ...
        public static void StartOnEngine(IEngine engine)
        {
            ...
            scene.AddObject(Bones.Create(new Vector2(10.5f, 2.5f)));
            scene.AddObject(Bones.Create(new Vector2(11.5f, 12.5f)));
            scene.AddObject(Bones.Create(new Vector2(10.5f, 16.5f)));
