...
{
    public class StaticLich : AnimatedObject
    {
        public StaticLich(Vector2 position, Animation currentAnimation) : base(position, Vector2.Zero, 0)
        {
        ...
        public static StaticLich Create(Vector2 position)
        {
            var animation = ResourceCachedLoader.Instance.GetAnimation("./animations/lich/static");

            return new StaticLich(position, animation);
        }
